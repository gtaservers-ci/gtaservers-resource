...
Locales['en'] = {
  ...
  sync_unreachable = '[gtaservers] Cannot reach %s: nothing answered the sync. Check this server can make outbound HTTPS requests. Rewards are paused until it can.',
  sync_failed = '[gtaservers] gtaservers.org answered the sync with HTTP %s. Rewards are paused until it succeeds.',
